...
DROP SEQUENCE megall_id;

CREATE SEQUENCE megall_id
    INCREMENT BY 1 START WITH 1000 MAXVALUE 100000000 MINVALUE 1000
    NOCACHE;

-- jarat tabla letrehozasa
CREATE TABLE jarat (
    vonatszam NUMBER(5,0) NOT NULL,
    tipus NVARCHAR2(7) NOT NULL,
    nap NVARCHAR2(7) DEFAULT '1111111' NOT NULL,
    kezd DATE,
    vege DATE,
    megjegyzes NVARCHAR2(40),
    CONSTRAINT "JARAT_KOD_PK" PRIMARY KEY(vonatszam),
    CONSTRAINT "JARAT_TIPUS_CK" CHECK (tipus IN ('szemely','Gyors','IC','EC')),
    CONSTRAINT "JARAT_DATUM_CK" CHECK (kezd < vege
                                       OR vege IS NULL)
);

-- allomas tabla letrehozasa
CREATE TABLE allomas (
     ...
     CONSTRAINT "ALLOMAS_UTASSZAM" CHECK (atlagutas >= 0 AND atlagutas <= 9000),
     CONSTRAINT "ALLOMAS_SZTRAJKMIN" CHECK (sztrajkutas >= atlagutas*0.2)
);

-- megall tabla letrehozasa
CREATE TABLE megall (
    ...
    CONSTRAINT "MEGALL_JARAT_FK" FOREIGN KEY(vonatszam) REFERENCES jarat(vonatszam),
...
INSERT INTO jarat VALUES (327,'IC','1111000',null,TO_DATE('2012-10-31','YYYY-MM-DD'),null);
INSERT INTO jarat VALUES (328,'IC','1111000',null,TO_DATE('2012-10-31','YYYY-MM-DD'),null);
INSERT INTO jarat VALUES (553,'IC','1010100',TO_DATE('2012-01-01','YYYY-MM-DD'),TO_DATE('2012-08-31','YYYY-MM-DD'),'Bufe nelkul');
INSERT INTO jarat VALUES (554,'IC','1010100',TO_DATE('2012-01-01','YYYY-MM-DD'),TO_DATE('2012-08-31','YYYY-MM-DD'),'Bufe nelkul');
-- INSERT INTO jarat VALUES (5551,'IC','1010100',TO_DATE('2012-01-01','YYYY-MM-DD'),TO_DATE('2012-12-31','YYYY-MM-DD'),'Sehol nem all meg');
INSERT INTO jarat VALUES (469,'IC','0000101',null,null,null);
INSERT INTO jarat VALUES (470,'IC','0000101',null,null,'Pentek-vasarnap');
INSERT INTO jarat VALUES (163,'IC','1000000',null,null,'lassu');
INSERT INTO jarat VALUES (164,'IC','1111111',null,null,null);
INSERT INTO jarat VALUES (2113,'Gyors','1110000',TO_DATE('2012-11-01','YYYY-MM-DD'),null,'uj jarat');
INSERT INTO jarat VALUES (4581,'szemely','1111111',null,TO_DATE('2012-12-31','YYYY-MM-DD'),'Mindenutt megall');
...
INSERT INTO jarat VALUES (1146,'Gyors','1111111',null,null,null);
INSERT INTO jarat VALUES (2265,'IC','1111100',null,null,null);
INSERT INTO jarat VALUES (2266,'IC','1111100',TO_DATE('1980-01-01','YYYY-MM-DD'),TO_DATE('2100-12-31','YYYY-MM-DD'),'Orokjarat');

-- Allomasok
INSERT INTO allomas VALUES (1,'Budapest-Keleti','Budapest',9000,2000);
INSERT INTO allomas VALUES (2,'Budapest-Nyugati','Budapest',9000,2000);
INSERT INTO allomas VALUES (3,'Budapest-Déli','Budapest',9000,2000);
INSERT INTO allomas VALUES (4,'Budapest-Kelenföld','Budapest',9000,2000);
INSERT INTO allomas VALUES (5,'Budapest-Ferencváros','Budapest',9000,2000);
INSERT INTO allomas VALUES (6,'Törökbálint','Törökbálint',6000,1200);
INSERT INTO allomas VALUES (7,'Biatorbágy','Biatorbágy',6000,1200);
INSERT INTO allomas VALUES (8,'Bicske','Bicske',6000,2000);
INSERT INTO allomas VALUES (9,'Tatabánya','Tatabánya',9000,3000);
INSERT INTO allomas VALUES (10,'Vértesszőlős','Vértesszőlős',1000,200);
INSERT INTO allomas VALUES (11,'Tata','Tata',9000,2000);
INSERT INTO allomas VALUES (12,'Almásfüzitő','Almásfüzitő',2000,400);
INSERT INTO allomas VALUES (13,'Komárom','Komárom',9000,1800);
INSERT INTO allomas VALUES (14,'Ács','Ács',1500,300);
INSERT INTO allomas VALUES (15,'Győr','Győr',9000,2000);
INSERT INTO allomas VALUES (16,'Hegyeshalom','Hegyeshalom',1700,500);
INSERT INTO allomas VALUES (17,'Wien-Südbahnhof','Bécs',9000,2400);

INSERT INTO allomas VALUES (18,'Enese','Enese',1000,200);
INSERT INTO allomas VALUES (19,'Eternitgyár','Lábatlan',2000,400);
INSERT INTO allomas VALUES (20,'Csorna','Csorna',1000,200);
INSERT INTO allomas VALUES (21,'Kapuvár','Kapuvár',1000,200);
INSERT INTO allomas VALUES (22,'Fertőszentmiklós','Fertőszentmiklós',1000,200);
INSERT INTO allomas VALUES (23,'Balf','Balf',1000,200);
INSERT INTO allomas VALUES (24,'Sopron','Sopron',9000,2000);

INSERT INTO allomas VALUES (25,'Dunakeszi','Dunakeszi',3000, 600);
INSERT INTO allomas VALUES (26,'Göd','Göd',2500,1000);
INSERT INTO allomas VALUES (27,'Sződliget','Sződliget',1500,300);
INSERT INTO allomas VALUES (28,'Vác','Vác',3000,600);
INSERT INTO allomas VALUES (29,'Verőcemaros','Verőcemaros',2000,500);
INSERT INTO allomas VALUES (30,'Nagymaros','Nagymaros',1500,300);
INSERT INTO allomas VALUES (31,'Zebegény','Zebegény',1000,200);
INSERT INTO allomas VALUES (32,'Szob','Szob',2300,1000);
INSERT INTO allomas VALUES (33,'Debrecen','Debrecen',9000,4000);
...
INSERT INTO allomas VALUES (37,'Székesfehérvár', 'Székesfehérvár', 8000, 3000);
INSERT INTO allomas VALUES (38,'Siófok', 'Siófok', 6000, 2000);
INSERT INTO allomas VALUES (39,'Keszthely', 'Keszthely', 5000, 2000);
INSERT INTO allomas VALUES (40,'Zalaegerszeg', 'Zalaegerszeg', 8000, 4000);
INSERT INTO allomas VALUES (41,'Szombathely', 'Szombathely', 9000, 4000);
--TODO Sáferkút
-- Miskolc-Tiszai -> Miskolc
-- Verebszár -> Szár
-- Eternitgyár -> Lábatlan
-- Zugló -> Budapest

-- Megállók
-- BP-Keleti -> BP-Kelenföld -> Györ -> Hegyeshalom -> Wien
INSERT INTO megall VALUES (1,213,1,null,0900);
INSERT INTO megall VALUES (2,213,4,0915,0918);
...
-- BP-Nyugati -> Dunakeszi -> Göd -> Sződliget -> Vác -> Veröcemaros
